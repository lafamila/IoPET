...
INSERT INTO `chat` (`ROOM_ID`, `CHAT_SEND`, `CHAT_TYPE`, `CHAT_MESSAGE`, `CHAT_DATETIME`, `CHAT_READ`) VALUES
(1, 1, 0, 'Hello!', '2018-10-18 00:00:00', 0),
(1, 0, 0, 'Ok, Hello!', '2018-10-18 01:02:00', 0),
(1, 0, 0, 'hello', '2018-10-18 19:09:26', 0),
(2, 0, 0, 'bybye', '2018-10-18 19:10:20', 0),
(3, 0, 0, 'bye\n', '2018-10-18 19:11:30', 0),
(2, 0, 0, 'hi', '2018-10-18 20:02:09', 0),
(2, 0, 0, 'hello', '2018-10-18 20:36:17', 0),
(2, 1, 0, 'say yeah!', '2018-10-18 20:38:19', 0),
(2, 1, 0, 'nonooooo', '2018-10-18 20:38:28', 0),
(2, 0, 0, 'yeah!', '2018-10-18 20:38:49', 0),
(2, 0, 0, 'eyah!!', '2018-10-18 20:39:04', 0),
(2, 0, 0, 'say hoihoi!', '2018-10-18 20:40:12', 0),
(2, 1, 0, 'hoihoi!', '2018-10-18 20:40:20', 0),
(2, 1, 0, 'are you busy?', '2018-10-18 20:41:53', 0),
(1, 0, 0, 'yeah...', '2018-10-18 20:42:09', 0),
(2, 1, 0, 'busy?', '2018-10-18 20:44:38', 0),
(2, 1, 0, 'oh...', '2018-10-18 20:48:09', 0),
(2, 1, 0, 'no!!!', '2018-10-18 20:48:58', 0),
(2, 1, 0, 'please answer me!!', '2018-10-18 20:51:24', 0),
(2, 1, 0, 'hi?', '2018-10-18 20:54:00', 0),
(2, 1, 0, 'please...', '2018-10-18 20:55:19', 0),
(2, 1, 0, 'ummmm', '2018-10-18 20:56:35', 0),
(2, 1, 0, 'ok.. then', '2018-10-18 20:57:17', 0),
(2, 1, 0, 'I will find you', '2018-10-18 20:57:24', 1),
(3, 1, 0, 'hello', '2018-10-18 21:32:51', 0);
...
(5, 1, '개 당뇨병(Diabetes mellitus)', '나트륨이 과다한 음식은 잦은 소변과 심혈관계 질환을 유발할 수 있으니 피해주세요. 한 주에 30분 이상의 운동을 추천합니다. 정기적인 관리를 하지 않으면 쿠싱과 저혈당 쇼크등의 합병증이 유발될 수 있으니 유의해주세요.', '요검사, 지속적 절식 고혈당증', '췌장염, 백내장, 당뇨병성 케톤산증, 부신겉질기능항진증, 비만 만성 신부전, 갑상샘기능저하증/항진증, 종양, 글루카곤증, 크롬친화세포종, 글루코코르티코이드 약물, 프로게스테론-분비성 부신겉질암종');
...
INSERT INTO `disease_medicine` (`DISEASE_ID`, `MEDI_ID`) VALUES
(1, 2),
(1, 4),
(2, 3),
(3, 2),
...
INSERT INTO `disease_symptom` (`DISEASE_ID`, `SYMPTOME_NAME`) VALUES
(1, '다뇨증'),
(1, '다음증'),
(1, '배뇨실금'),
(2, '대칭성 탈모증'),
...
(1, '콜라', 8, '포메라니안', 4, 3, 0, '털이 거칠고 피부에 발적', '권기빈', '010-1234-6789', 1),
(2, '사이다', 2, '웰시코기', 3.4, 0, 0, '엄청 귀여움', '이경민', '010-6412-3292', 1),
...
INSERT INTO `stock` (`STOCK_ID`, `STOCK_NAME`, `STOCK_PRICE`) VALUES
(1, '의약품', 0),
(2, '기본 진료비', 12000),
(3, '혈액검사', 34000),
(4, '초음파', 31300);
